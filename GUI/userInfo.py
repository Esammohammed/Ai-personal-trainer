...
"}")
        ...
        self.pushButton = QtWidgets.QPushButton(self.frame_3 ,Clicked=lambda: up.Update(self.user.text()
                                 ,self.name.text(),self.email.text() ,
                        self.password.text(),self.age.text(),self.height.text(),self.weight.text() ,self.level.text(),self.gender.text()))
...
"}")
    ...
    def edit_text(self,z):
        self.z.setReadOnly(False)
