...
"")
        ...
        if self.lineEdit.text()== "" or self.lineEdit_3.text() == "" or self.lineEdit_4.text() == "" or self.lineEdit_5.text() == "" \
            ...
            try:
                ...
                if row != None:
                    msg = QMessageBox()
                    msg.setIcon(QMessageBox.Critical)
                    msg.setText("User already Exist,Please try with another Email")
                    msg.setWindowTitle("Error")
                    msg.exec_()
                    ...
                    cur.execute("insert into register values(%s,%s,%s,%s)"
                                ...
                                , (self.lineEdit.text(), self.lineEdit_3.text(),
                                   ...
                                   self.lineEdit_5.text(), self.lineEdit_2.text() ))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Enter the First Name"))
        ...
        self.lineEdit_3.setPlaceholderText(_translate("MainWindow", "Enter the Last Name"))
