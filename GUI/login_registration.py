...
class Login:
    ...
    def loginform(self):
        ...
        img = Label(Frame_login, image=self.img).place(x=0, y=0, width=980, height=700)

        frame_input = Frame(self.root, bg='white')

        frame_input.place(x=350, y=150, height=450, width=350)
        ...
        self.password = Entry(frame_input, show="*", font=("times new roman", 15, "bold"),

                              bg='lightgray')

        self.password.place(x=30, y=245, width=270, height=35)

        check_button = Checkbutton(frame_input, text="Show Password", font=("times new roman", 10, "bold"), bg='white',
                                   command=self.showpassword)

        check_button.place(x=25, y=285)
    ...
    def Register(self):
        ...
        img = Label(Frame_login1, image=self.img).place(x=0, y=0, width=980, height=700)
        ...
        self.entry2 = Entry(frame_input2, font=("times new roman", 15, "bold"), show='*',

                            bg='lightgray')

        self.entry2.place(x=30, y=245, width=270, height=35)

        check_button = Checkbutton(frame_input2, text="Show Password", font=("times new roman", 10, "bold"), bg='white',
                                   command=self.showpassword_register)
        ...
        self.entry4 = Entry(frame_input2, font=("times new roman", 15, "bold"), show='*',
    ...
    def showpassword_register(self):
