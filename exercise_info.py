...
class Ui_Frame(object):
    ...
    def setupUi(self, Frame):
        ...
        self.squatButton.clicked.connect(self.squatClicked)
        ...
        self.pushUpButton.clicked.connect(self.pushUpClicked)
        ...
        self.bicepsButton.clicked.connect(self.bicepsClicked)
        ...
        self.shoulderPressButton.clicked.connect(self.shoulderPressClicked)

        self.textBrowser = QtWidgets.QTextBrowser(Frame)
        self.textBrowser.setGeometry(QtCore.QRect(380, 50, 641, 711))
        ...
        self.lateralRaisesButton.clicked.connect(self.lateralRaisesClicked)
